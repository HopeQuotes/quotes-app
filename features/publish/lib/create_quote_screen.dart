              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    AnimatedContainer(
                      curve: Curves.fastOutSlowIn,
                      height: hashTagInputVisible == VisibilityState.visible
                          ? 62
                          : 0,
                      width: hashTagInputVisible == VisibilityState.visible
                          ? 600
                          : 0,
                      duration: const Duration(milliseconds: 300),
                      child: TransitionAnimWidget(
                    ...
                    AnimatedOpacity(
                      opacity:
                          bodyInputVisible == VisibilityState.visible ? 1.0 : 0,
                      duration: const Duration(milliseconds: 100),
                      child: AnimatedContainer(
                        curve: Curves.fastOutSlowIn,
                        duration: const Duration(milliseconds: 300),
